...
# for i in [8]:
    ...
    # Save out
    out_dir = '{:s}/plots_v2/stats_bw'.format(main_dir)
    check_dir(out_dir)
    fig.savefig('{:s}/stats_bw_{:s}.pdf'.format(out_dir, telescope[i]))
